...
peer channel create -o orderer.clemson.com:7050 -c channel1 -f ./channel-artifacts/channel/channel.tx
...
export CORE_PEER_MSPCONFIGPATH=/opt/gopath/channel-artifacts/certs/peerOrganizations/university.clemson.com/users/Admin@student.clemson.com/msp
...
peer channel update -o orderer.clemson.com:7050 -c channel1 -f ./channel-artifacts/channel/UniversityMSPanchors.tx
...
peer channel update -o orderer.clemson.com:7050 -c channel1 -f ./channel-artifacts/channel/StudentMSPanchors.tx
